...
class HistoryScreen extends StatelessWidget {
  HistoryScreen({Key? key, this.historyId}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body:
            // FutureBuilder(
            //     future: Provider.of<HistoryViewModel>(context).history(historyId!),
            ...
            //       } else {
            //         final result =
            //             Provider.of<HistoryViewModel>(context).resultHistory;
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          // Text("${result.createdAt}", style: title3Sans),
